...
public class DTableUpdateManager {
    ...
    public void update(final GuidedDecisionTable52 model,
        ...
        for (final Coordinate coordinate : coordinates) {
            if (coordinate.getCol() != GuidedDecisionTable52.RULE_NUMBER_INDEX
                    && coordinate.getCol() != GuidedDecisionTable52.RULE_NAME_COLUMN_INDEX
                    && coordinate.getCol() != GuidedDecisionTable52.RULE_DESCRIPTION_INDEX) {
